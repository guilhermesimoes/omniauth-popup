class SessionsController < ApplicationController
  def create
    ...
    flash[:notice] = t('controllers.sessions.create.notice', provider: omniauth.provider.titleize)
  ...
  def failure
    flash[:alert] = t('controllers.sessions.failure.alert', provider: params[:strategy].titleize)
